class LibBuilder {
    static #scripts_ = [
        ...
        "Components/MeshRenderer", "Components/Light",
        "Utils/Utils", "Utils/Type", "Utils/Logger", 
        "Graphics/Canvas", "Graphics/Mesh", "Graphics/Texture",
            "Graphics/Shaders/Shader", "Graphics/Shaders/ShaderProgram", "Graphics/Shaders/Material",
            "Graphics/Renderer/Renderer", "Graphics/Renderer/RenderBatch", "Graphics/Renderer/RenderSubBatch",
        "Mathf/Mathf", "Mathf/Vector2", "Mathf/Vector3", "Mathf/Matrix4", "Mathf/Color"
    ];
