class Vector3 {
    ...
    get normalized() {
        ...
        return new Vector3(this.#x_ / length, this.#y_ / length, this.#z_ / length);
    }
    ...
    multiplyByMatrix4(mat4) {
        ...
        //this.#x_ = matrix4.columns[0].x * x + matrix4.columns[1].x * y + matrix4.columns[2].x * z + matrix4.columns[3].x;
		//this.#y_ = matrix4.columns[0].y * x + matrix4.columns[1].y * y + matrix4.columns[2].y * z + matrix4.columns[3].y;
		//this.#z_ = matrix4.columns[0].z * x + matrix4.columns[1].z * y + matrix4.columns[2].z * z + matrix4.columns[3].z;
