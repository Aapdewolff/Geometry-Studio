class Application {
    ...
    static async init(debug = false) {
        ...
        if(window.WebAssembly)
            Application.#webAssembly_ = true;
        else
            Application.#webAssembly_ = false;
        
        
        if(Application.#webAssembly_)
            await Wasm.init(initEssentials);
        else
            initEssentials();
    ...
    static get webAssembly() { return Application.#webAssembly_; }
    static set webAssembly(value) { console.error("Application.webAssemble is readonly!"); }
